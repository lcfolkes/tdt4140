...
/*      name = "Ola Nordmann";
    ...
    public void testGenerateID() {
        assertEquals(0, User.numberOfUsers); //Begins as zero
        assertEquals(1, u1.generateID());
        assertEquals(2, u1.generateID());
    }
    @Test
    public void testGetNumberOfUsers() {
        ...
        u1.generateID();
        u1.generateID();
        assertEquals(2, User.getNumberOfUsers());
    }
    ...
    public void testAdvancedConstructor() throws Exception {
        ...
        assertEquals(1, User.getNumberOfUsers());
    }

...
When creating and modifying the GUI with JavaFX, [Scene Builder](http://gluonhq.com/products/scene-builder/) was utilized to construct GUI-elements, such as Text Fields and Buttons, and more. After installing, open Eclipse, select the "Window"-tab --> "Preferences" --> JavaFX and locate the Scene Builder executable file. 

## Operating Instructions
The application runs through one core .java file. located inn the **tdt4140-gr1823.app.ui**-subfolder **src/main"java**, called **FxApp.java**. With the help of a scene navigator, the FxApp manages to interconnect the functionality in **MainScreen.java** and **FxFiltering.java**, which contain functionality for the MainScreen-window and the Filtering-window respectively. By right-clicking on **FxApp.java** and selecting _Run As_ --> _Java Application_, the screen below will be presented (follow the link):
